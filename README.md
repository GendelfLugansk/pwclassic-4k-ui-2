## Кастомный интерфейс Perfect World для 4k мониторов для версии игры 1.3.6 (сервер pwclassic)
...
* Рекомендуется удалить файлы внутри папки `element\userdata\Layout\`. Это позволит автоматически расположить 
